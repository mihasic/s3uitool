...
test.describe("SQS", () => {
  ...
  test("views seeded messages and opens details", async ({ page }) => {
    await page.goto("/default/sqs/orders-queue");
  ...
  test("sends a message", async ({ page }) => {
    ...
    await page.goto("/default/sqs/email-jobs");
  ...
  test("purges a queue via the confirm dialog", async ({ page }) => {
    ...
    await page.goto("/default/sqs/notifications-dlq");
