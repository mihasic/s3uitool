...
|---|---|---|---|---|---|---|---|---|
| 1 | `download_prefix` | 9 | 42 | 4 | `s3Routes.get(/buckets/:bucket/download/:key{.+})` | 8 | 22 | 2 |
| 2 | `fetch_objects` | 7 | 40 | 2 | `entries` | 8 | 22 | 2 |
| 3 | `list_objects_batch` | 5 | 43 | 3 | `onError` | 6 | 16 | 2 |
| 4 | `download_object` | 5 | 18 | 2 | `fetchObjects` | 6 | 37 | 2 |
| 5 | `copy_prefix` | 5 | 20 | 2 | `step` | 6 | 25 | 2 |
| 6 | `get_client` | 4 | 16 | 1 | `envCredentials` | 5 | 8 | 1 |
